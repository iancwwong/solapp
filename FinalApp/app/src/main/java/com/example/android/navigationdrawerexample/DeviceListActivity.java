...
/*
    This code was provided kindly by Harry Goodwill, with his permission to allow Team New South Solutions
    to use the code in whatever way we desire.
    The site this code was borrowed from is:
